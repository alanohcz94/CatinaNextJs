    ...
    <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
      <div className="col-span-3">
        ...
        <div className="space-y-8">
          ...
          <p>
            Our {cabins.length > 0 ? cabins.length : 0} luxury cabins provide a cozy base, but the real freedom and
      ...
      <div className="col-span-2">
        <Image src={aboutImage2} alt="Family that manages The Wild Oasis" placeholder="blur" quality={80}/>
      </div>
